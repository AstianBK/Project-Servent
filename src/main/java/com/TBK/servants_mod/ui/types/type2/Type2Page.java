package com.TBK.servants_mod.ui.types.type2;
 ...
 */
public class Type2Page extends InteractiveCustomUIPage<Type2Page.GreetEventData> {
    ...
    public Type2Page(@Nonnull PlayerRef playerRef) {
