...
public class SensorEntityMarker extends SensorBase {
    ...
    public SensorEntityMarker(@NonNull BuilderSensorEntityMarker builder, BuilderSupport builderSupport) {
        super(builder);
        this.messageIndex = builder.getMessageSlot(builderSupport);
        this.range = builder.getRange(builderSupport);
        this.targetSlot = builder.getTargetSlot(builderSupport);
        this.consume = builder.isConsume();
